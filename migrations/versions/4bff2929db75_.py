...
Revision ID: 4bff2929db75
Revises: fc499fe8b017
Create Date: 2019-01-26 05:17:03.657648
...
revision = '4bff2929db75'
down_revision = 'fc499fe8b017'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('network', sa.VARCHAR(), nullable=False),
    ...
    sa.Column('price_range', sa.VARCHAR(), nullable=False),
